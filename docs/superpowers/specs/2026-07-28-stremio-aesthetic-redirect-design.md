...
| **HowItWorks** | The rail elaborated into a full routing diagram: three cables, source → add-on → screen. Not a second idea competing with the rail — the same object at the one point where the content earns it, because the content genuinely is a sequence. |
